...
urlpatterns = [
    ...
    path('laptop/', views.mobile, name='laptop'),
    path('laptop/<slug:data>/', views.mobile, name='laptopdata'),
    ...
    path('changepassword/', views.CustomerPasswordChangeView.as_view(), name='changepassword'),
    path('passwordchangedone/', auth_views.PasswordChangeDoneView.as_view(template_name='app/passwordchangedone.html'), name='passwordchangedone'),
    
    path('password-reset/', 
         auth_views.PasswordResetView.as_view(template_name='app/password_reset.html', form_class=MyPasswordResetForm), 
         name='password_reset'),
    ...
    path('edit-address/<int:id>/', views.edit_address, name='editaddress'),
    ...
    path('cancel-order/<int:id>/', views.cancel_order, name='cancelorder'),
